#ifndef CAFFE_EUCLIDEANWEIGHT_LOSS_LAYER_HPP_
#define CAFFE_EUCLIDEANWEIGHT_LOSS_LAYER_HPP_
...
class EuclideanWeightLossLayer : public LossLayer<Dtype> {
 public:
  explicit EuclideanWeightLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param), diff_() {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "EuclideanWeightLoss"; }
  /**
